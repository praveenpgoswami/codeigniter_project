 ...
 */
  ...
  class Google_ProductsServiceResource extends Google_ServiceResource {
     ...
     * @opt_param string images Image images specification
     ...
     * @opt_param string images image specification
     * @opt_param bool plusOne.useGcsConfig Whether to use +1 button styles configured in the GCS account
...
class Google_ShoppingModelProductJsonV1Images extends Google_Model {
  public $status;
  public $link;
  protected $__imagesType = 'Google_ShoppingModelProductJsonV1Imagesimages';
  protected $__imagesDataType = 'array';
  public $images;
  ...
  public function setimages(/* array(Google_ShoppingModelProductJsonV1Imagesimages) */ $images) {
    $this->assertIsArray($images, 'Google_ShoppingModelProductJsonV1Imagesimages', __METHOD__);
    $this->images = $images;
  }
  public function getimages() {
    return $this->images;
...
class Google_ShoppingModelProductJsonV1Imagesimages extends Google_Model {
  public $content;
  public $width;
  public $link;
  public $height;
