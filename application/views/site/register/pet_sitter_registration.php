  ...
  <div class="main main-box">
    <div class="container">
      <div class="col-md-12">
        ...
        <h1> Passionate about pet care?  Create a free pet-sitter profile</h1>
        ...
        <div class="section-how-it-work">
          ...
          <p>Once you register as a pet sitter here you can browse pet owners seeking pet-sitters in your area and use stayrove's secure messaging service to contact them.</p>
    ...
    <form name="register-pet-sitter" id="register-pet-sitter" class="form-horizontal" method="post" action="site/register/pet_sitter_registration" enctype="multipart/form-data">
        <div class="error_register_pet_sitter">
          <?php
            if(form_error()):
          ...
          <label class="control-label">I am happy to pet sit in:</label>
            <div class="col-sm-8">
              ...
              <textarea id="s_other_location" name="s_other_location" placeholder="Enter more information about your available locations"></textarea>
                ...
                <input type="number" min="0" name="s_owners_house_rate" id="s_owners_house_rate" placeholder="(enter your rate)" disabled="disabled" value="<?php echo set_value('s_owners_house_rate'); ?>" style="width: 49%;"/> /day
              </label>
                ...
                <input type="number" min="0" name="s_rown_premises_rate" id="s_rown_premises_rate" placeholder="(enter your rate) - no specification for travel etc." disabled="disabled" value="<?php echo set_value('s_owners_house_rate'); ?>" style="width: 54%;"> /day
              </label>
          ...
          <div class="top-box">
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-8">
                ...
                <span class="help-block">  Your name or nickname:</span>
              </div>
            </div>
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-8">
                ...
                <input id="s_mobile_number" type="number" min="0" name="s_mobile_number" value="<?php echo set_value('s_mobile_number'); ?>" placeholder="Mobile number "> <a href="javascript:void(0)" id="mobile_varification">Verify</a> <span class="loader-img"><img src="<?php echo base_url()?>images/ajax-loader-small.gif"></span>
                <div class="error-msg">
           ...
           <div class="help-block1">
                By registering as a sitter on stayrove.com you are agreeing to our<a href="https://stayrove.freshdesk.com/support/solutions/articles/5000545522-terms-and-conditions" target="_blank"> Terms</a> and <a href="https://stayrove.freshdesk.com/support/solutions/articles/5000545523-privacy-policy" target="_blank">Privacy Policy  </a>
        <!-- </form> -->
