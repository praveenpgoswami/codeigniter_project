      ...
      <?php } ?>
            ...
            <label class="control-label">My sexuality:</label>
              <div class="col-sm-8">
                <select name="s_sexuality" id="s_sexuality" class="gends">
                  ...
                  <?php
                  $s_sexuality = set_value('s_sexuality');
                  if (array_key_exists('s_sexuality', $sitter_registration_fields)) :
                  foreach ($sitter_registration_fields['s_sexuality'] as $key => $value) : ?>
                    <option value="<?php echo $key; ?>" <?php echo ($key == $s_sexuality) ? set_select('s_sexuality', $s_sexuality) : ''; ?>><?php echo $value; ?></option>
                  <?php endforeach; endif; ?>
                </select>
                <div class="error-msg">
                <?php echo form_error('s_sexuality', '<label class="error">', '</label>'); ?>
                </div>
            </div>
          </div>
          <div class="crl"></div>
        ...
        <div class="top-box">
         ...
         <div class="form-group required">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-8">
              <label class="radio-inline">
                <input name="s_comfortable_with" value="dogs" type="radio" class="chack"> Dogs
              </label>
              <label class="radio-inline">
                <input type="radio" value="cats" name="s_comfortable_with" class="chack"> Cats
              </label>
              <label class="radio-inline">
                <input type="radio" value="others" name="s_comfortable_with" class="chack" id="other_comfortable_with"> Other
          ...
          <div class="form-group ">
            ...
            <div class="col-sm-8">
              <div class="chack-full"> <input type="radio" value="1" name="s_prefer_pet" class="chack" >   Extremely active or need regular walks or entertainment  </div>
              <div class="chack-full"> <input type="radio" value="2" name="s_prefer_pet" class="chack">   Moderately active </div>
              <div class="chack-full"> <input type="radio" value="3" name="s_prefer_pet" class="chack">   Sedentary or indoors</div>
            </div>
          </div>
        ...
        <div class="form-group required">
          <label class="control-label">Suburb or Postcode:</label>
            <div class="col-sm-8">
              <input id="s_suburb" type="text" name="s_suburb" value="" placeholder="Enter your postcode or suburb">
              <div class="error-msg">
          ...
          <label class="control-label">I am happy to pet sit in:</label>
            <div class="col-sm-8">
              ...
              <textarea id="s_other_location" name="s_other_location" placeholder="Enter more information about your available locations"></textarea>
				...
				<div class="form-group required">
					<label class="control-label">My charges: I will pet-sit:</label>
						<div class="col-sm-8">
  						<div class="chack-full first-box">
                <input type="radio" value="1" name="s_charges" class="chack" >  In the pet owners house, at a rate of
                <input type="number" min="0" name="s_owners_house_rate" id="s_owners_house_rate" placeholder="(enter your rate)" disabled="disabled" /> /day
                 <div class="error-msg"></div>
              </div>
  						<div class="chack-full">
                <input type="radio" value="2" name="s_charges" class="chack">    In my own premises, at a rate of
                <input type="number" min="0" name="s_rown_premises_rate" id="s_rown_premises_rate" placeholder="(enter your rate including travel)" disabled="disabled"> /day
                 <div class="error-msg"></div>
              </div>
        ...
        <div class="top-box">
          <h2>When I am available to pet sit</h2>
				...
				<label class="control-label">When:</label>
					<div class="col-sm-8">
					  <input type="radio" value="short_term" name="s_length_of_time" class="chack" >  <label>Short term (2-3 days or less)</label>
						<input type="radio" value="medium_term" name="s_length_of_time" class="chack"><label>Medium term</label>
						<input type="radio" value="longer_term" name="s_length_of_time" class="chack"> <label>Longer term</label>
            <div class="error-msg">
              <?php echo form_error('s_length_of_time', '<label class="error">', '</label>'); ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="chack-full"> <input type="radio" value="yes" name="s_insurance" id="s_insurance" class="chack" >
						...
						<label class="control-label"> Something more about me</label>
							<div class="col-sm-8">
								<textarea name="s_about_me" id="s_about_me" placeholder="Enter a brief summary that you’d like displayed on your profile" rows="10" cols="45"></textarea>
								<div class="error-msg">
								<?php echo form_error('s_about_me', '<label class="error">', '</label>'); ?>
                </div>
								<span class="help-block">Help me - I don't know what to say...</span>
							</div>
						</div>
            <div class="crl"></div>
          </div>
...
$(function(){
  ...
  $(document).ready(function() {
    ...
    $(':radio[name="s_charges"]').change(function() {
      var s_charges = $(this).val();
