  ...
  <div class="main main-box own">
    <div class="container">
      <div class="col-md-12">
        ...
        <h1>It's free and easy to find a pet sitter</h1>
        <div class="tag-line1">With 1,000s of pet sitters on stayrove - we'll connect you with the perfect carer for your pet.</div>
        <hr />
        ...
        <form name="register-pet-owner" id="register-pet-owner" role="form" class="form-horizontal" method="post" action="site/register/pet_owner_registration" enctype="multipart/form-data">
          <div class="error_register_pet_owner">
            <?php
            if(form_error()):
              if(isset($validation_error)) echo $validation_error;
            endif; ?></div>
          <div class="top-box">
            <h2>THE BASICS</h2>
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-8">
                <input type="text" class="o_from_date" style="width:33%" name="o_from_date" value="<?php echo set_value('o_from_date'); ?>" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy"/> To
                <input type="text" class="o_to_date" style="width:33%" name="o_to_date" value="<?php echo set_value('o_to_date'); ?>" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy"/>
                <div class="error-msg">
                <?php echo form_error( 'o_from_date', '<label class="error">', '</label>'); ?>
                <?php echo form_error( 'o_to_date', '<label class="error">', '</label>'); ?>
                </div>
                <div class="padding-15 help-block"> For your security only the month of your request and your suburb will be displayed on your profile.</div>
              </div>
            </div>
            ...
            <div class="form-group required">
              <label class="control-label">I prefer my pet sitter to be:</label>
              <div class="col-sm-8">
            ...
            <div class="form-group required">
              <label class="control-label">Pet-sitting location:</label>
              <div class="col-sm-8">
            ...
            <div class="form-group required">
                <label class="control-label" for="o_amount">I am willing to pay:</label>
                <div class="col-sm-8">
                <input type="number" min="0" name="o_amount" id="o_amount" value="<?php echo set_value('o_amount'); ?>" placeholder="Dollars" />
                <div class="error-msg">
                <?php echo form_error( 'o_amount', '<label class="error">', '</label>'); ?>
                </div>
                <span class="help-block">Enter a maximum amount you are willing to pay /day.</span>
              </div>
            </div>
          </div>
          ...
          <div class="top-box">
            ...
            <div class="form-group required">
              ...
              <div class="col-md-7">
                <select name="o_pet_type[]" id="o_pet_type" class="gends multi-empty" multiple="multiple">
                  ...
                  foreach ($owner_registration_fields['o_pet_type'] as $key => $value) : ?>
                    <option value="<?php echo $key; ?>" <?php echo (in_array($key,$o_pet_type)) ? 'selected' : ''; ?>><?php echo $value; ?></option>
                  <?php endforeach; endif; ?>
                </select>
                <div class="error-msg">
            ...
            <div class="col-sm-2"></div>
            <div class="col-sm-8"> <span class="help-block"><p>This is the first impression prospective pet-sitters get of you and your pet so keep in relevant, interesting and short.</span> </div>
          ...
          <div class="top-box">
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-8">
                ...
                <span class="help-block">Enter a short name for your profile ie 'Julius the poodle' or 'three cats and a bunny'.</span>
              </div>
            </div>
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-8">
                ...
                <input id="o_mobile_number" type="number" min="0" name="o_mobile_number" value="<?php echo set_value('o_mobile_number'); ?>" placeholder="Mobile number "> <a href="javascript:void(0)" id="mobile_varification">Verify</a> <span class="loader-img"><img src="<?php echo base_url()?>images/ajax-loader-small.gif"></span>
                <div class="error-msg">
                <?php echo form_error( 'o_mobile_number', '<label class="error">', '</label>'); ?>
                </div>
                <span class="help-block">You must *verify* your mobile number to register.</span>
              </div>
            </div>
...
$(function(){
  ...
  $(document).ready(function(){
    ...
    $.validator.addMethod("uploadImg", function(value, element) {
     ...
     $.validator.addMethod("multi-empty", function(value, element) {
        return this.optional(element) == '';
