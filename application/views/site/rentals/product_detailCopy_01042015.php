            ...
            <div class="listing-menu">
                <div class="listing-menu-left">
                    ...
                    <li> <h2 class="titled"><?php echo ucfirst($product->product_title); ?></h2></li>
                     <li><?php  echo $product->CityName.', '.$product->State_name.', '.$product->Country_name; ?>
                     </li>
...
FB.init({
    appId: '1526159784309917', status: true, cookie: true, xfbml: true }); 
};
...
return false;
                    ...
                    <div class="fb-sect">
                         ...
                         <label>Share<?php echo $fbAppId;?></label>
                        ...
                        <li>
						<a class="fba1" href="<?echo $url;?>" data-image="<?php echo base_url().PRODUCTPATH.$productImages->row()->product_image;?>" data-title="<?echo $product->meta_title;?>" data-desc="<?echo $product->meta_description;?>" onClick="fbShare();return false;"></a></li>
