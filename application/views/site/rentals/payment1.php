...
//echo '<pre>'; print_r($servicetax); die;
$country = $countryList; 
?>
                    ...
                    <ul class="checkin-details-left cheks-status">
                     ...
                     <ul class="checkin-details-right cheks-status">
                        <li>
							...
							$commission = number_format($servicetax->commission_percentage*$this->session->userdata('currency_r'),2);
							
							}
							else {
							$commission = number_format($product->serviceFee*$this->session->userdata('currency_r'),2);
							}
                            ...
                            <span> <?php echo $currencySymbol."  ".$pricePerNight; ?></span>
                        </li>
                         ...
                         <li>
							...
							echo $currencySymbol."  ".$commission;
                         ...
                         <li>
                            <label>Total:</label>
                            <span><?php
									echo $currencySymbol."  ".number_format($product->totalAmt*$this->session->userdata('currency_r'),2);
									?>
						</span>
                        </li>
...
<div class="payed-container">
            <article class="pay-head">
                ...
                <!--<label>Already registered with Staynest? Login </label>-->
            </article>
            ...
            <div class="over-view-details">
			 ...
			 <form method="post" action="site/user/booking_confirm/<?php echo $this->uri->segment(2); ?>" id="credit_card_form" >
               ...
               <!-- <li>
                 ...
                 <li>
                    ...
                    <input type="text" name = "firstname" value="<?php echo $BookingUser->firstname; ?>" required>
                </li>

                <li>
                    <span>Last Name</span>
                    <input type="text" name = "lastname" value="<?php echo $BookingUser->lastname;?>" required>
                </li>

                 <li>
                    <span>Country</span>
                    <select name = "country" id="phone_country" onchange="get_mobile_code(this.value)" required>
                ...
                <li class="caling-area">
                   ...
                   <!-- <select>
					...
					<input type="text"  value="" style="width:40px;" maxlength="3" />
                    <input type="text" name = "phone_no" id="phone_no" maxlength="10" required>
                </li>
...
<div align="center">
<!--<a href="site/user/booking_confirm/<?php echo $this->uri->segment(2); ?>">--><input type="submit" id="bookbtn" name="bookbtn" value="BOOK NOW" style="height:50px;background-color:#0190e2;color:#FFF;width:150px;"/><!--</a>-->
</div>
           ...
           <select><option>United State</option><option>2</option></select>
              ...
              <div id="occ" class="pad1">
				...
				<!-- final value End -->
					...
					<input type="hidden" id="user_id" name="user_id"  value="<?php echo $BookingUser->userid;?>"/>
					<input type="hidden" name="price" id="price" value="<?php echo $product->totalAmt; ?>"/>
