                    ...
                    <div class="city_type_field">
                        ...
                        <ul class="city_type_field_btn">
                            ...
                            <li>
                                ...
                                <span><input type="text" class="cityser" id="cityser" autocomplete="off" onKeyPress="javascript:ViewSubmitbutton('1');" name="city" placeholder="Accord,New York,United States..." />
        ...
        <div class="main">
            ...
            <ul class="dashboard_links">
                ...
                <li class="center">
                    ...
                    <h3>Every host is verified by Facebook and Telephone</h3>
               ...
               <li class="center">
                    ...
                    <h3>Transparency no hidden fees</h3>
                ...
                <li class="center">
                    ...
                    <div class="trust_box"><img src="images/site/host_couple.jpg" /></div>
