...
<link rel="stylesheet" type="text/css" media="all" href="css/site/<?php echo SITE_COMMON_DEFINE ?>jquery-ui-1.8.18.custom.css" />
            ...
            <div class="calender_box_main">
                ...
                <div class="calender_box">
                    ...
                    <?php if($listDetail->row()->calendar_checked!='' && $listDetail->row() == 'Publish') {?>
					<a name="calendar" style="cursor:pointer;" class="btn gray mini example16" data-pid="<?php echo $listDetail->row()->id;?>" data-price="<?php echo $listDetail->row()->price;?>" href="javascript:void(0);">
                      <?php if($this->lang->line('Edit_calendar') != '') { echo stripslashes($this->lang->line('Edit_calendar')); } else echo "Edit calendar";?></a> 
					<?php }else {?>
...
jQuery(function()
{
jQuery('.ui-button-text').text('<?php if($this->lang->line('FinishMyListing') != '') { echo stripslashes($this->lang->line('FinishMyListing')); } else echo "Finish My Listing";?>');
});
</script>
<style>
.ui-draggable-handle
...
<p class="listing-down-creat"><?php if($this->lang->line('YouveCreatedYourListing') != '') { echo stripslashes($this->lang->line('YouveCreatedYourListing')); } else echo "Youve Created Your Listing";?></p>
<span class="sixbtn">8</span>
<p class="more-step"><?php if($this->lang->line('morestepstolist') != '') { echo stripslashes($this->lang->line('morestepstolist')); } else echo "more steps to list your space.";?></b>.
</p>
</div>
