...
<div class="top-listing-head">
 ...
 <div id="example-two">
        ...
        <ul class="nav">
                <li class="nav-one"><a href="<?php echo base_url().'inbox';?>" class="current">Inbox</a></li>
                <li class="nav-two"><a href="<?php echo base_url().'sentbox';?>" >Sent</a></li>
        </ul>
...
$this->data ['userdetail'] = $this->cms_model->get_all_details (USERS, array ('id' => $InboxStr->guide_id));
                                            ...
                                            <td><div class="edit"><a href="site/user_settings/view_conversation_details/<?php echo $InboxStr->convId;?>">View Message</a>&nbsp;<a onclick="return confirm('Are you sure want to delete?');" href="site/user_settings/delete_conversation_details/<?php echo $InboxStr->convId;?>">Delete</a></div>
...
//$this->data ['userdetail'] = $this->cms_model->get_all_details (USERS, array ('id' => $InboxStr->guide_id));
                                            ...
                                            <td><?php echo $InboxStr->message; ?></td>
                                            <td><?php echo $InboxStr->date_created; ?></td>
                                            <td><div class="edit"><a href="site/user_settings/view_inquiry_details/<?php echo $InboxStr->convId;?>">View Message</a></div>
