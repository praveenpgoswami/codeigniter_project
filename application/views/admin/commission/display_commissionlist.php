				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<td class="center" style="text-transform:capitalize;">
								<?php echo $row->commission_percentage; if($row->promotion_type=='percentage'){echo '%';}?>
							</td>
						...
						<td class="center">
							...
							if ($allPrev == '1' || in_array('2', $Commission)){
								...
								if ($mode == '0'){
							?>
								<a title="Click to inactive" class="tip_top" href="javascript:confirm_status('admin/commission/change_commission_status/<?php echo $mode;?>/<?php echo $row->id;?>');"><span class="badge_style b_done"><?php echo $row->status;?></span></a>
							<?php
								}else {	
							?>
								<a title="Click to active" class="tip_top" href="javascript:confirm_status('admin/commission/change_commission_status/<?php echo $mode;?>/<?php echo $row->id;?>')"><span class="badge_style"><?php echo $row->status;?></span></a>
							<?php 
								}
							}else {
							?>
							...
							<?php if ($allPrev == '1' || in_array('2', $Commission)){?>
								<span><a class="action-icons c-edit" href="admin/commission/edit_commission_form/<?php echo $row->id;?>" title="Edit">Edit</a></span>
							<?php }?>
