				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<td class="center">
								<?php echo $currencySymbol.number_format($tax_amount[$row->id],2,'.',',');?>
							</td>
							<td class="center">
							...
							<td class="center">
								<?php 
								echo $currencySymbol.number_format($remain_amount[$row->id],2);
								?>
							</td>
							<td class="center">
								<?php 
								echo $currencySymbol.number_format($commission_to_admin[$row->id],2);
								//echo $currencySymbol.number_format($tax_amount[$row->id],2);
								?>
							</td>
							<td class="center">
								<?php 
								echo $currencySymbol.number_format($amount_to_vendor[$row->id],2);
								
								// $amtventor = ($total_amount[$row->id])-($tax_amount[$row->id]);
								// echo $currencySymbol.number_format($amtventor,2);
							...
							<td class="center">
								<?php 
								echo $currencySymbol.number_format($TotalAdminAmt[$row->id],2);
								?>
							</td>
							<td class="center">
							...
							<td class="center">
									...
									<span class="action_link"><a class="p_approve tipTop" href="admin/commission/add_pay_form/<?php echo $row->id;?>" title="Pay balance due">Pay</a></span>
									<?php }?>
							</td>
						</tr>
						<?php 
