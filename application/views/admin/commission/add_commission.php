					...
					?>
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="commission_type" id="commission_type" type="text" tabindex="1" class="required large tipTop" title="Please enter the user First Name"/>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="commission_percentage" id="commission_percentage" type="text" tabindex="1" class="required large tipTop" title="Please enter the user Last Name"/>
									</div>
								</div>
								</li>
                              <li>
