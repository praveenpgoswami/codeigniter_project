	...
	<div id="content">
		...
		?>
			<div class="review_top">
				<p class="fl"><span class="r_left fl">Booking Id : </span><span class="fl">#<?php echo $order_details->row()->dealCodeNumber;?></span></p>
				<p class="fr"><span class="r_left fl">Sub Total : </span><span class="fl"><?php echo $currencySymbol.number_format($subTotal,2);?></span></p>
				<div style="clear: both;"></div>
				<p class="fl"><span class="r_left fl">Booking Date : </span><span class="fl"><?php echo $order_details->row()->created;?></span></p>
                <p class="fl"><span class="r_left fl">Checkin Date : </span><span class="fl"><?php echo $order_details->row()->checkin;?></span></p>
                <p class="fl"><span class="r_left fl">Checkout Date : </span><span class="fl"><?php echo $order_details->row()->checkout;?></span></p>
...
<!-- 			<hr class="review_hr"> -->
		...
		?>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="float:left;border:1px solid #cecece; width:99.5%;">
		        <tbody>
			        <tr bgcolor="#f3f3f3">
			        	<td width="14%" style="border-right:1px solid #cecece; text-align:center;"><span style="font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#000000; line-height:38px; text-align:center;">Rental Image</span></td>
			            <td width="42%" style="border-right:1px solid #cecece;text-align:center;"><span style="font-size:12px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#000000; line-height:38px; text-align:center;">Rental Name</span></td>
			            ...
			            <td style="border-right:1px solid #cecece; text-align:center;border-top:1px solid #cecece;"><span style="font-size:13px; font-family:Arial, Helvetica, sans-serif; font-weight:normal; color:#000000; line-height:30px;  text-align:center;"><img src="<?php echo base_url();?>server/php/rental/<?php echo $prodImg;?>" alt="<?php echo $prod_details[$orderRow->product_id]->row()->product_title;?>" width="70"></span></td>
