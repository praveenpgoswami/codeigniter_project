...
$(function () {
 ...
 var s1 = [[2004, 104000], [2005, 99000], [2006, 121000],
    ...
    <!--<div class="switch_bar">
		<ul>
			<li><a href="admin/users/display_user_list" ><span class="stats_icon user_sl"><span class="alert_notify orange"><?php echo $totalUserCounts;?></span></span><span class="label">Members</span></a>
			</li>
            ...
            <li><a href="admin/product/display_product_list"><span class="stats_icon folder_sl"><span class="alert_notify orange"><?php echo $getTotalProductCount;?></span></span><span class="label">Rental</span></a></li>
       	...
       	<br>
                ...
                <div class="user_s" style="float: left !important; margin-right: 8px;">
					<div class="block_label">
						Total Members<span><?php echo $totalUserCounts;?></span>
					</div>
					<span class="badge_icon customers_sl"></span>
				</div>
				<div class="views_s">
					<div class="block_label">
						Total Property List<span><?php echo $getTotalProductCount;?></span>
					</div>
					<span class="badge_icon bank_sl"></span>
				</div>
				<div class="activities_s">
					<div class="block_label">
						Total Hosts<span><?php echo $getTotalSellerCount;?></span>
					</div>
					</div>
					<!--<div class="activities_s">
					<div class="block_label">
						Today Members<span><?php echo $todayUserCounts;?></span>
					</div>
					</div>
					<div class="activities_s">
					<div class="block_label">
						Today Property List<span><?php echo $getTodayProductCount;?></span>
					</div>
					</div>
					<div class="activities_s">
					<div class="block_label">
						Today Hosts<span><?php echo $getTodaySellerCount;?></span>
					</div>
					</div>-->
						...
						<div class="user_list">
							...
							<div class="user_block">
								<div class="info_block">
									...
									<ul class="list_info">
										<li><span>Name: <i><a href="admin/users/view_user/<?php echo $userList['id'];?>"><?php echo stripslashes($userList['firstname']); ?></a></i></span></li>
...
.
social_activities{padding-top:0}
</style>