						...
						foreach ($data as $key => $value) : ?>
								<tr>
									...
									<?php	if ($allPrev == '1' || in_array('2', $Members)){
										...
										if ($mode == '0'){ ?>
										<a title="Click to inactive" class="tip_top" href="javascript:confirm_status('admin/users/change_pet_sitter_status/<?php echo $mode;?>/<?php echo $value["user_id"];?>');"><span class="badge_style b_done"><?php echo $value['status'];?></span></a>
										<?php	}else {	?>
											<a title="Click to active" class="tip_top" href="javascript:confirm_status('admin/users/change_pet_sitter_status/<?php echo $mode;?>/<?php echo $value["user_id"];?>')"><span class="badge_style"><?php echo $value['status'];?></span></a>
										<?php	}
										}else {	?>
										...
										<?php if ($allPrev == '1' || in_array('3', $Members)){?>
											<span><a class="action-icons c-delete" href="javascript:confirm_delete('admin/users/delete_pet_sitter/<?php echo $value["user_id"]; ?>')" title="Delete">Delete</a></span>
										<?php }?>
										</td>
								</tr>
