					...
					<div class="widget_content">
						...
						<tr>
							...
							<?php 
								...
								if ($modeid == '0'){
								?>
								<a title="Click to inactive" class="tip_top" href="javascript:confirm_status('admin/seller/verify_user_liststatus/<?php echo $modeid;?>/<?php echo $row->id;?>');"><span class="badge_style b_done"><?php echo $row->other;?></span></a>
								<?php
								}else {	
							?>
								<a title="Click to active" class="tip_top" href="javascript:confirm_status('admin/seller/verify_user_liststatus/<?php echo $modeid;?>/<?php echo $row->id;?>')"><span class="badge_style"><?php echo $row->other;?></span></a>
							<?php 
								}
							?>
							</td></center>
