				...
				<div class="widget_wrap">
					...
					?>
						...
						<ul>
							...
							<div class="form_input"><img src="<?php if($list_value_details->row()->image==''){ echo base_url().'images/users/user-thumb1.png';}else{ echo base_url();?>images/attribute/<?php echo $list_value_details->row()->image;}?>" width="100px"/></div>
							</div>
							</li>
