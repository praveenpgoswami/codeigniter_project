	 						...
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										...
										<?php } else { ?>
										<label style="font-weight:bold;"><?php echo base_url().'order/ipnpayment';?></label></br></br>
										<label style="font-style: italic;"><a href="https://developer.paypal.com/docs/classic/ipn/integration-guide/IPNSetup/" target="_blank">Click here</a> to read more about Paypal IPN settings.</label>
										<?php } ?>
									</div>
								</div>
								</li>
