	...
	<div id="header" class="white_gel">
		<div class="header_left">
			...
			<div id="responsive_mnu">
				...
				<li><a href="<?php echo base_url();?>admin/dashboard/admin_dashboard" <?php if($currentUrl=='dashboard'){ echo 'class="active"';} ?>> Dashboard</a></li>
				...
				<li><a href="#" <?php if($currentUrl=='adminlogin'){ echo 'class="active"';} ?>> Admin<span class="up_down_arrow">&nbsp;</span></a>
				...
				<li><a href="#" <?php if($currentUrl=='subadmin'){ echo 'class="active"';} ?>> Subadmin<span class="up_down_arrow">&nbsp;</span></a>
				...
				<li><a href="#" <?php if($currentUrl=='users'){ echo 'class="active"';} ?>> Users<span class="up_down_arrow">&nbsp;</span></a>
				<ul class="acitem" <?php if($currentUrl=='users'){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
					...
					<li><a href="admin/users/display_user_list" <?php if($currentPage=='display_user_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Users Users List</a></li>
				...
				<li><a href="#" <?php if($currentUrl=='seller' || $currentUrl=='commission'){ echo 'class="active"';} ?>> Renters<span class="up_down_arrow">&nbsp;</span></a>
				<ul class="acitem" <?php if($currentUrl=='seller' || $currentUrl=='commission'){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
					...
					<li><a href="admin/seller/display_seller_list" <?php if($currentPage=='display_seller_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Renters List</a></li>
				...
				<li><a href="#" <?php if($currentUrl=='product' || $currentUrl=='comments'){ echo 'class="active"';} ?>> Rentals<span class="up_down_arrow">&nbsp;</span></a>
                  ...
                  <li><a href="admin/product/display_rental_dashboard" <?php if($currentPage=='display_rental_dashboard'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Dashboard</a></li>
					...
					<li><a href="admin/product/display_product_list" <?php if($currentPage=='display_product_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Rentals List</a></li>
					...
					<li><a href="admin/product/add_product_form" <?php if($currentPage=='add_product_form'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Add New Rental</a></li>
					<?php }?>
				</ul>
				</li>
				...
				<li><a href="#" <?php if($currentUrl=='membership'){ echo 'class="active"';} ?>> Membership Package<span class="up_down_arrow">&nbsp;</span></a>
				<ul class="acitem" <?php if($currentUrl=='membership'){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
	                <li><a href="admin/membership/display_membership_dashboard" <?php if($currentPage=='display_membership_dashboard'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Dashboard</a></li>
                    <li><a href="admin/membership/membership_list" <?php if($currentPage=='membership_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Subscribed Members</a></li>
					<li><a href="admin/membership/display_membership" <?php if($currentPage=='display_membership'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Membership Package List</a></li>
					<?php if ($allPrev == '1' || in_array('1', $membership)){?>
					<li><a href="admin/membership/add_membership_form" <?php if($currentPage=='add_membership_form'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Add Membership Package</a></li>
					<?php }?>
				</ul>
				</li>
                ...
                <li><a href="#" <?php if($currentUrl=='order' || $this->uri->segment(1,0)=='order-review'){ echo 'class="active"';} ?>>Orders<span class="up_down_arrow">&nbsp;</span></a>
				...
				<li><a href="#" <?php if($currentUrl=='contact' || $this->uri->segment(1,0)=='contact-review'){ echo 'class="active"';} ?>> Contact Owners <span class="up_down_arrow">&nbsp;</span></a>
				<ul class="acitem" <?php if($currentUrl=='contact' || $this->uri->segment(1,0)=='order-review'){ echo 'style="display: block;"';}else{ echo 'style="display: none;"';} ?>>
                <li><a href="admin/contact/display_contact_dashboard" <?php if($currentPage=='display_contact_dashboard'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Dashboard </a></li>
					<li><a href="admin/contact/display_contact_list" <?php if($currentPage=='display_contact_list'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Contact List </a></li>
				</ul>
				</li>

				<?php } if ((isset($attribute) && is_array($attribute)) && in_array('0', $attribute) || $allPrev == '1'){ 	?>
				<li><a href="#" <?php if($currentUrl=='attribute'){ echo 'class="active"';} ?>>List<span class="up_down_arrow">&nbsp;</span></a>
				...
				<li><a href="#" <?php if($currentUrl=='productattribute'){ echo 'class="active"';} ?>> Attribute<span class="up_down_arrow">&nbsp;</span></a>
				...
				<li><a href="#" <?php if($currentUrl=='couponcards'){ echo 'class="active"';} ?>> Coupon Codes<span class="up_down_arrow">&nbsp;</span></a>
				...
				<li><a href="#" <?php if($currentUrl=='newsletter'){ echo 'class="active"';} ?>> Newsletter Template<span class="up_down_arrow">&nbsp;</span></a>
				...
				<li><a href="#" <?php if($currentUrl=='location'){ echo 'class="active"';} ?>> Location<span class="up_down_arrow">&nbsp;</span></a>
				...
				<li><a href="#" <?php if($currentUrl=='cms'){ echo 'class="active"';} ?>> Pages<span class="up_down_arrow">&nbsp;</span></a>
				...
				<li><a href="#" <?php if($currentUrl=='city'){ echo 'class="active"';} ?>> City Management<span class="up_down_arrow">&nbsp;</span></a>
				...
				<li><a href="admin/paygateway/display_gateway" <?php if($currentUrl=='paygateway'){ echo 'class="active"';} ?>> Payment Gateway</a></li>
				<?php
				}if ((isset($multilang) && is_array($multilang)) && in_array('0', $multilang) || $allPrev == '1'){ ?>

                <li><a href="admin/multilanguage" <?php if($currentUrl=='multilanguage'){ echo 'class="active"';} ?>> Language Management</a></li><?php }?>
                <li><a href="#" <?php if($currentUrl=='slider' || $currentUrl=='comments'){ echo 'class="active"';} ?>> Slider<span class="up_down_arrow">&nbsp;</span></a>
            ...
            <?php   if ((isset($testimonials) && is_array($testimonials)) && in_array('0', $testimonials) || $allPrev == '1'){ ?>
            	...
            	<li><a href="#" <?php if($currentUrl=='testimonials' || $this->uri->segment(1,0)=='testimonials-review'){ echo 'class="active"';} ?>> Testimonials <span class="up_down_arrow">&nbsp;</span></a>
                ...
                <!--<li><a href="admin/testimonials/add_testimonials_form" <?php if($currentPage=='display_testimonials_dashboard'){ echo 'class="active"';} ?>><span class="list-icon">&nbsp;</span>Dashboard </a></li>-->
