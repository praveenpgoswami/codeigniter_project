		...
		<div class="grid_container">
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						$attributes = array('class' => 'form_container left_label', 'id' => 'mass_email');
					...
					?>
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="subject" style=" width:295px" id="subject" type="text" tabindex="1" value="" class="required tipTop" title="Please enter the sender name"/>
									</div>
								</div>
								</li>
                                <li>
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <textarea cols="60" rows="10" class="tipTop mceEditor" name="message" id="message_content"></textarea>
									</div>
								</div>
								</li>
                                <li>
