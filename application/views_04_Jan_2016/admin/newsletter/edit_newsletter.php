					...
					?>
	 						<ul>
								...
								<div class="form_grid_12">
                                    ...
                                    <input name="news_title" style=" width:295px" id="news_title" value="<?php echo $user_details->row()->news_title;?>" type="text" tabindex="1" class="required tipTop" title="Please enter the email template name"/>
									</div>
								</div>
								</li>
								<li>
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="news_subject" style=" width:295px" id="news_subject" value="<?php echo $user_details->row()->news_subject;?>" type="text" tabindex="1" class="required tipTop" title="Please enter the email template subject"/>
									</div>
								</div>
								</li>
                                 <li>
