					...
					<div class="widget_top">
						...
						<?php if ($allPrev == '1' || in_array('2', $user)){?>
							<?php if($enable == 'off'){?><div class="btn_30_light" style="height: 29px;">
								<a href="admin/adminlogin/enable_slider" class="tipTop"><span class="icon accept_co"></span><span class="btn_link">Enable Slider</span></a>
							</div>
							<?php } else {?>
							<div class="btn_30_light" style="height: 29px;">
								<a href="admin/adminlogin/disable_slider" class="tipTop"><span class="icon delete_co"></span><span class="btn_link">Disable Slider</span></a>
							</div>
							<?php }?>
							<div class="btn_30_light" style="height: 29px;">
					...
					<div class="widget_content">
				     ...
				     <th class="tip_top" title="Click to sort">Slider Link</th>
						...
						<tr>
							...
							<?php if ($row->image != ''){?>
								 <img class="rollovereff" width="40px" height="40px" src="<?php echo base_url();?>images/slider/<?php echo $row->image;?>" />
							<?php }else {?>
