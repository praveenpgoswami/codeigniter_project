                    	...
                    	<div id="tab1">
	 						<ul>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="logo" style=" width:295px" id="logo" type="file" tabindex="1" class="required tipTop" title="Please enter the Logo"/>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="thumb" style=" width:295px" id="thumb" type="file" tabindex="1" class="required tipTop" title="Please enter the image"/>
									</div>
								</div>
								</li>
                                ...
                                <li>
                                  <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                      <textarea name="description" id="description" tabindex="3" class="large tipTop mceEditor required" title="Please enter the description"></textarea>
                                    </div>
                                  </div>
                                </li>
