			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<select data-placeholder="Select a Coupon Type" name="coupon_type" style=" width:300px" class="chzn-select-deselect" tabindex="13" onchange="coupon_proudct(this.value);">
						            ...
						            <option value="Advertisement" <?php if($couponcard_details->row()->coupon_type == 'Advertisement'){ echo 'selected="selected"';}?>>Advertisement</option>
									<option value="Birthday Card" <?php if($couponcard_details->row()->coupon_type == 'Birthday Card'){ echo 'selected="selected"';}?>>Birthday Card</option>
									<option value="Business Travel" <?php if($couponcard_details->row()->coupon_type == 'Business Travel'){ echo 'selected="selected"';}?>>Business Travel</option> 
                                    <option value="Gift Card" <?php if($couponcard_details->row()->coupon_type == 'Gift Card'){ echo 'selected="selected"';}?>>Gift Card</option> 
                                    <option value="Promotion" <?php if($couponcard_details->row()->coupon_type == 'Promotion'){ echo 'selected="selected"';}?>>Promotion</option>
                                    <option value="Staff" <?php if($couponcard_details->row()->coupon_type == 'Staff'){ echo 'selected="selected"';}?>>Staff</option>	
                   	</select>
									</div>
								</div>
								</li>
