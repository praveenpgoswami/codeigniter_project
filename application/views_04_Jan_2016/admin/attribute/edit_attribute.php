		...
		<div class="grid_container">
			<div class="grid_12">
                ...
                <ul>
							...
							<div class="form_input">
								<input name="attribute_title" id="attribute_title" type="text" tabindex="1" class="required large tipTop" title="Please enter the list Title"  value="<?php echo $attribute_details->row()->attribute_title;?>"/>
							</div>
							</div>
							</li>
