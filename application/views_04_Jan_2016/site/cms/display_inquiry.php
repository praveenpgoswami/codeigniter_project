 ...
 <div id="container-wrapper bg-gray" style="background:#f5f5f5">
	...
	<div class="main3">
		...
		<!-- / wrapper-content -->
		   ...
		   <img src="<?php echo base_url().'server/php/rental/'.$productDetails->row()->PImg; ?>" width="100" height="100"/><br>
...
receiver_id="<?php echo $sender_id;?>" product_id="<?php echo $pageDetails->row()->rental_id;?>" reviewer_id="<?php  echo $receiver_id; ?>">Reply</a>
<?php }else {?>
<a href="javascript:;" onclick="window.history.go(-1); return false;">Back</a>
<?php }?>
</div>			
    </div>
</section>
