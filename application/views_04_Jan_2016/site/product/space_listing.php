            ...
            <div class="dashboard_price_main">
            	...
            	<div class="dashboard_price">
                    ...
                    <div class="dashboard_price_left">
                    	...
                    	<h3><?php if($this->lang->line('RoomsandBeds') != '') { echo stripslashes($this->lang->line('RoomsandBeds')); } else echo "Rooms and Beds"; ?></h3>
                    ...
                    <div class="dashboard_price_right">
                    	...
                    	<div class="dashboard_apart width100">
                        	...
                        	<label><?php if($this->lang->line('Bedrooms') != '') { echo stripslashes($this->lang->line('Bedrooms')); } else echo "Bedrooms"; ?></label>
                        ...
                        <div class="dashboard_apart">
                        	...
                        	<label><?php if($this->lang->line('Beds') != '') { echo stripslashes($this->lang->line('Beds')); } else echo "Beds"; ?></label>
                        ...
                        <div class="dashboard_apart">
                        	...
                        	<label><?php if($this->lang->line('BedType') != '') { echo stripslashes($this->lang->line('BedType')); } else echo "Bed Type"; ?></label>
                        ...
                        <div class="dashboard_apart width100">                        
                        	<label><?php if($this->lang->line('Bathrooms') != '') { echo stripslashes($this->lang->line('Bathrooms')); } else echo "Bathrooms"; ?></label>
                            <div class="select">
                        ...
                        <div class="dashboard_apart width100">                        
                        	<label><?php if($this->lang->line('NumberofBathrooms') != '') { echo stripslashes($this->lang->line('NumberofBathrooms')); } else echo "Number of Bathrooms"; ?></label>
                            <div class="select">
                        	...
                        	<label><?php if($this->lang->line('MinimumStay') != '') { echo stripslashes($this->lang->line('MinimumStay')); } else echo "Minimum Stay"; ?></label>
					 ...
					 ?>
                      <div class="dashboard_apart">
                          ...
                          <label><?php echo $value->attribute_name; ?></label>
                            <div class="select">
							<select  name="home_type"  onchange="javascript:Detailview(this,<?php echo $listDetail->row()->id; ?>,'<?php if($value->attribute_name == 'Home Type')echo 'home_type';else if($value->attribute_name == 'Room Type') echo 'room_type';?>');">
							<?php
						 ...
						 if($pcount == 0){
						 ?>  
							  <option  <?php if(trim($listvalues->list_value) == trim($listDetail->row()->home_type)) echo 'selected="selected"'; ?> ><?php echo $listvalues->list_value; ?></option>
							  <?php }else{  ?>
							   <option  <?php if(trim($listvalues->list_value) == trim($listDetail->row()->room_type)) echo 'selected="selected"'; ?> ><?php echo $listvalues->list_value; ?></option>
                        ...
                        <div class="dashboard_apart">
                          ...
                          <label><?php if($this->lang->line('Accommodates') != '') { echo stripslashes($this->lang->line('Accommodates')); } else echo "Accommodates"; ?></label>
