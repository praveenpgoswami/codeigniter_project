...
zoomControlOptions: {
  style:google.maps.ZoomControlStyle.SMALL
    ...
    center: new google.maps.LatLng(<?php if($productList->row()->latitude!=''){ echo $productList->row()->latitude;}else if($city_lat_lng->row()->latitude!=''){echo $city_lat_lng->row()->latitude;} else echo $lat; ?>,<?php if($productList->row()->longitude!=''){ echo $productList->row()->longitude;}else if($city_lat_lng->row()->longitude!=''){ echo $city_lat_lng->row()->longitude;} else echo $long; ?>),
    mapTypeControl: true,
