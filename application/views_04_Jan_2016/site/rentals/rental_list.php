...
zoomControlOptions: {
  style:google.maps.ZoomControlStyle.SMALL
    ...
    center: new google.maps.LatLng(<?php if($city_lat_lng->row()->latitude!=''){ echo $city_lat_lng->row()->latitude;}else{ echo '37.4419';} ?>,<?php if($city_lat_lng->row()->longitude!=''){ echo $city_lat_lng->row()->longitude;}else{ echo '-122.1419';} ?>),
    mapTypeControl: true,
...
?>
  ...
  <?php }?> 
    ...
    <li title="Keywords" data-tooltip-position="left" rel="tooltip" class="clearfix showlist5">
      ...
      <input type="text" placeholder="ocean side, transit, relaxing..." value="<?php echo $_GET['keywords']; ?>" name="keywords" id="keywords" class="span6">
    </li>
    


      <div class="showlisting">
        <a class="show-btn23">Show Listing</a>
      </div>
     </form>
  ...
  <div class="map" >
    <div id="map_canvas" style="width: 544px; height: 100%;"></div>
