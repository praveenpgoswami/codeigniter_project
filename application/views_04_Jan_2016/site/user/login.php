...
?>                    
                ...
                <div class="sns-minor top" style="display:none;" >
                    <span class="trick"></span>
                    <i class="arrow"></i>
                    <ul>
                        
                        <li><button class="btn-b social bk" data-backend="VK" data-type="signin" next="/"><span class="icon ic-bk"><i></i></span> <b><?php if($this->lang->line('login_bkohrakte') != '') { echo stripslashes($this->lang->line('login_bkohrakte')); } else echo "BKohrakte"; ?></b></button></li>
                        <li><button class="btn-r social renren" data-backend="renren" data-type="signin" next="/"><span class="icon ic-re"><i></i></span> <b><?php if($this->lang->line('signup_renren') != '') { echo stripslashes($this->lang->line('signup_renren')); } else echo "Renren"; ?></b></button></li>
                        <li><button class="btn-w social weibo" data-backend="weibo" data-type="signin" next="/"><span class="icon ic-we"><i></i></span> <b><?php if($this->lang->line('signup_weibo') != '') { echo stripslashes($this->lang->line('signup_weibo')); } else echo "Weibo"; ?></b></button></li>
