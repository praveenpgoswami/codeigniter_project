...
class Register extends MY_Controller {
  ...
  public function index(){
    ...
    if($this->form_validation->run() == FALSE) {
      ...
      $o_pet_type = (!empty($this->input->post ( 'o_pet_type' ))) ? serialize($this->input->post ( 'o_pet_type' )) : '';     
      ...
      $this->setErrorMessage('success','<strong>Congratulation!</strong> You have successfully registerd as a pet owner.!');
      redirect(base_url());
    }
  }
  ...
  public function pet_sitter_registration(){
    ...
    if($this->form_validation->run() == FALSE) {
      ...
      $s_experience = $this->input->post ( 's_experience' );
			...
			$s_prefer_pet = (!empty($this->input->post ( 's_prefer_pet' ))) ? serialize($this->input->post ( 's_prefer_pet' )) : '';
      ...
      $s_suburb = $this->input->post ( 's_suburb' );
			...
			$s_charges = (!empty($this->input->post ( 's_charges' ))) ? serialize($this->input->post ( 's_charges' )) : '';

      //When I am available to pet sit INFO
      $s_length_of_time = (!empty($this->input->post ( 's_length_of_time' ))) ? serialize($this->input->post ( 's_length_of_time' )) : '';
      ...
      $this->setErrorMessage('success','<strong>Congratulation!</strong> You have successfully registerd as a pet sitter.!');
      redirect(base_url());
		  #$this->load->view('site/register/pet_sitter_registration',$this->data);
  	}
  }
