...
class Rentals extends MY_Controller {
	...
	public function mapview() {
		...
		$json = file_get_contents("http://maps.google.com/maps/api/geocode/json?address=$googleAddress&sensor=false");
		...
		$search = '(1=1';
		$whereLat = '(pa.lat < '.$aLat.' AND pa.lat > '.$bLat.' AND pa.lang < '.$aLong.' AND pa.lang >'.$bLong.')';
