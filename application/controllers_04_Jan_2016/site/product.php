		...
		//echo $this->uri->segment(1,0);
	 	if ($this->data['loginCheck'] != ''){
			...
			if(in_array($this->uri->segment(1,0),$ListingStepsArr)){
				...
				if($this->data['Steps_address']->num_rows() > 0 && $this->data['Steps_address']->row()->lat != ''){
...
$(function(){
	...
	public function address_listing($prdid='')
		{
			if ($this->checkLogin('U') != '')
			{
				...
				//echo '<pre>';print_r($this->data['rental_address']->result());die;
	...
	require_once('twilio/Services/Twilio.php'); //include sms API
