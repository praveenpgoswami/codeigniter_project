...
<div style=\"display: inline-block; font-size: 13px; width: 100%; margin: 0; padding: 0; font-family: Helvetica,Arial,sans-serif;\"><span>Hi</span><label style=\"padding: 0 0 0 2px;\">user,</label>
<div style=\"display: inline-block; width: 100%; margin: 0px; font-family: Helvetica,Arial,sans-serif; font-size: 14px; padding: 9px 0px 6px;\">Welcome! In order to get started, you need to confirm your email address.</div>
